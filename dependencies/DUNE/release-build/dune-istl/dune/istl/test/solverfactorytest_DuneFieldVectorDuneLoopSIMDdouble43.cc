...
using Vector = Dune::BlockVector<Dune::FieldVector<Dune::LoopSIMD<double, 4>, 3>>;
...
using Matrix = Dune::BCRSMatrix<typename MatrixBlock<Dune::FieldVector<Dune::LoopSIMD<double, 4>, 3>>::type>;
