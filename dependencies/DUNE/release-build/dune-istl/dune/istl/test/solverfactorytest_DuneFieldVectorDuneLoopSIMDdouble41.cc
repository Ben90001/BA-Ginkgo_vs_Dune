...
using Vector = Dune::BlockVector<Dune::FieldVector<Dune::LoopSIMD<double, 4>, 1>>;
...
using Matrix = Dune::BCRSMatrix<typename MatrixBlock<Dune::FieldVector<Dune::LoopSIMD<double, 4>, 1>>::type>;
