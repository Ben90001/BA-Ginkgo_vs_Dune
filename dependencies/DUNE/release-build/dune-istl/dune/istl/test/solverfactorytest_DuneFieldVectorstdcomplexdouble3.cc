...
using Vector = Dune::BlockVector<Dune::FieldVector<std::complex<double>, 3>>;
...
using Matrix = Dune::BCRSMatrix<typename MatrixBlock<Dune::FieldVector<std::complex<double>, 3>>::type>;
